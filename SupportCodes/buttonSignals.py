...
class ButtonSignals():
    ...
    def buttonCallbackGraphWindow(self):
        ...
        self.gp.mainBox.activated[str].connect(lambda: UI_Buttons_Graph.changeGraph(self))
        self.gp.domainBox.activated[str].connect(lambda: UI_Buttons_Graph.changeGraph(self))
        self.gp.samplingBox.activated[str].connect(lambda: UI_Buttons_Graph.changeGraph(self))
