...
class UI_Buttons_LoginFunctions():
    def __init__(self):
        super(UI_Buttons_LoginFunctions, self).__init__()

    def login(self):
        username = self.ui.loginLineEdit.text()
        password = self.ui.passwordLlineEdit.text()
        UI_Buttons_LoginFunctions.loginUser(self, username, password)


    def register(self):
        username = self.ui.loginLineEdit.text()
        password = self.ui.passwordLlineEdit.text()
        UI_Buttons_LoginFunctions.registerUser(self, username, password)
